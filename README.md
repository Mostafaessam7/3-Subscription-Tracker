...
- **`.github/workflows/ci.yml` (Job الفرونت اند) لسه بيستخدم Node 18** رغم إن المشروع اترقّى لـ Angular 22 (بيتطلب رسميًا `^20.19.0 || ^22.12.0 || ^24.0.0`) — Node 18 EOL ومش من ضمن المدى المدعوم، فالـ CI فعليًا معرّض للفشل حتى لو كل حاجة شغالة محليًا بـ Node أحدث. راجع [GAPS.md](GAPS.md#فجوة-15-ci-لسه-بيستخدم-node-18-للفرونت-اند-مش-متوافق-مع-angular-22--مفتوحة) للتفاصيل. لسه مش متصلح.
